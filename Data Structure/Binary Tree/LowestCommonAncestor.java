...
Next line will be n elements separated by spaces representing the elements to be inserted into the BST. The code for inserting the values in the tree has already been taken care of in the code.
...
Output: The output should be of the following format
       Value of lowest common ancestor of the nodes n1 and n2.
