...
public class UserActivity {
	...
	public void deleteQuestion(UserActivity userActivity, User user) throws NumberFormatException, IOException {
		...
		Question question = getQuestion();
		UserRole questionOwner = question.getUser().getUserRole();
		...
		if (user.getUserRole() == UserRole.ADMIN) {
			...
			// User can delete all questions except Admin owned questions
			if(!(questionOwner == UserRole.ADMIN)){
			...
			// User can only delete his/her question
			if(questionOwner == user.getUserRole() && !(questionOwner == UserRole.MODERATOR || questionOwner == UserRole.ADMIN)){
				questionService.deleteQuestion(question);
			}else{
				System.out.println("You are not authorised to delete this question");
			}
